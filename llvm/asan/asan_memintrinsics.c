...
void *__wrap_memcpy(void *dst, const void *src, size_t sz)
    SYMBOL_ALIAS("__asan_memcpy");
void *__wrap_memset(void *src, int c, size_t sz) SYMBOL_ALIAS("__asan_memset");
void *__wrap_memmove(void *src, const void *dst, size_t sz)
    SYMBOL_ALIAS("__asan_memmove");
void __wrap_bcopy(const void *src, void *dst, size_t sz)
    SYMBOL_ALIAS("__asan_bcopy");
void __wrap_bzero(void *dst, size_t sz) SYMBOL_ALIAS("__asan_bzero");
int __wrap_bcmp(const void *a, const void *b, size_t sz)
    SYMBOL_ALIAS("__asan_bcmp");
int __wrap_memcmp(const void *a, const void *b, size_t sz)
    SYMBOL_ALIAS("__asan_memcmp");
...
size_t __wrap_strlcpy(char *dst, const char *src, size_t sz)
    SYMBOL_ALIAS("__asan_strlcpy");
char *__wrap_strncpy(char *dst, const char *src, size_t sz)
    SYMBOL_ALIAS("__asan_strncpy");
size_t __wrap_strlcat(char *dst, const char *src, size_t sz)
    SYMBOL_ALIAS("__asan_strlcat");
char *__wrap_strncat(char *dst, const char *src, size_t sz)
    SYMBOL_ALIAS("__asan_strncat");
size_t __wrap_strnlen(const char *src, size_t sz)
    SYMBOL_ALIAS("__asan_strnlen");
...
void __real_bcopy(const void *UNUSED src, void *UNUSED dst, size_t UNUSED sz) {
...
void *__real_memmove(void *UNUSED src, const void *UNUSED dst,
                     size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
void *__real_memcpy(void *UNUSED src, const void *UNUSED dst,
                    size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
void __real_bzero(void *UNUSED dst, size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
int __real_bcmp(const void *UNUSED a, const void *UNUSED b, size_t UNUSED len) {
  asan_internal_unsupported(__func__);
}
#endif
...
int __real_memcmp(const void *UNUSED a, const void *UNUSED b,
                  size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
char *__asan_strcat(char *dst, const char *src) {
  asan_internal_check_range(dst, __real_strlen(dst) + __real_strlen(src) + 1,
                            TYPE_STRINGSTR);
  return __real_strcat(dst, src);
}

#ifndef PLATFORM_ASAN_HAVE_STRCPY
char *__real_strcat(char *UNUSED dst, const char *UNUSED src) {
  asan_internal_unsupported(__func__);
}
#endif
...
#ifndef PLATFORM_ASAN_HAVE_STRCPY
char *__real_strcpy(char *UNUSED dst, const char *UNUSED src) {
  asan_internal_unsupported(__func__);
}
#endif
...
size_t __real_strlcpy(char *UNUSED dst, const char *UNUSED src,
                      size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
size_t __real_strlcat(char *UNUSED dst, const char *UNUSED src,
                      size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
char *__real_strncpy(char *UNUSED dst, const char *UNUSED src,
                     size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
char *__real_strncat(char *UNUSED dst, const char *UNUSED src,
                     size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
size_t __real_strnlen(const char *UNUSED src, size_t UNUSED sz) {
  asan_internal_unsupported(__func__);
}
#endif
...
size_t __real_strlen(const char *UNUSED src) {
  asan_internal_unsupported(__func__);
}
#endif
