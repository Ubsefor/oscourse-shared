...
// The header file for UBSAN support in JOS based on the UBSAN porting example
// which was given with the task.
...
#ifndef __BIT
#define __BIT(__n)                                                             \
  (((uintptr_t)(__n) >= CHAR_BIT * sizeof(uintptr_t))                          \
       ? 0                                                                     \
       : ((uintptr_t)1 << (uintptr_t)((__n) &                                  \
                                      (CHAR_BIT * sizeof(uintptr_t) - 1))))
#endif
